...
import { Tabs, Card, Typography, Row, Col, Statistic, Button, Table, Tag, Space, Modal, Form, Input, Select, InputNumber, DatePicker, App } from 'antd';
import { Coins, Globe, Briefcase, Plus, Search, TrendingUp, Users, FilePlus, Edit2, Trash2 } from 'lucide-react';
    ...
    <div className="py-10">
        ...
        <Table 
            ...
            columns={[
                ...
                { title: 'Status', dataIndex: 'status', render: (s: any) => <Tag color="blue">{s.toUpperCase()}</Tag> },
...
const CustomerCRMTab = () => {
    ...
    useEffect(() => {
        api.get('/business/customers').then(res => setCustomers(res.data)).catch(() => {
            setCustomers([{ id: 1, name: 'Huawei Logistics', code: 'HW', contact: 'Mr. Zhang', phone: '138...' }] as any);
        });
    }, []);
    return (
        <Table 
